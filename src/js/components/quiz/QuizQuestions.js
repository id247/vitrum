...
const answers = {
	good: (
		<p>
			Вы неплохо разбираетесь в витаминах — это здорово! Узнать ещё больше полезной информации, чтобы во всеоружии встретить осенне-зимний сезон, Вы можете в <a href={PromoOptions.endQuizLink}>материалах нашего проекта!</a>
		</p>
		),
	bad: (
		<p>
			Чтобы подкрепить знания о витаминах и узнать, как поддержать организм школьника в осенне-зимний период, воспользуйтесь <a href={PromoOptions.endQuizLink}>полезными материалами нашего проекта</a>!'
		</p>
	),
};
